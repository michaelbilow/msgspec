...
# Copying them into localns also prevents same-named module globals from shadowing
# the type parameter on Python versions where ForwardRef replaces globalns.
